...
const handleDeleteChat = async (id:Id<"chats">) =>{
    ...
    return <>
        ...
        <div className={cn(
            "fixed md:inset-y-0 top-14 bottom-0 left-0 z-50 w-72 bg-gray-50/80 backdrop-blur-xl border-r border-gray-200/50 shadow-sm hover:shadow transition-all duration-200 transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:top-0 flex flex-col",
            ...
            <div className='p-4 border-b border-gray-200/50'>
                <Button className='w-full bg-white hover:bg-gray-50 text-gray-700 border border-gray-200/50 shadow-sm hover:shadow transition-all duration-200'
                    ...
                    >
                    <PlusIcon className='mr-2 h-4 w-4' />New Gossip
                </Button>
            </div>
