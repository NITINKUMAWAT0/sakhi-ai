  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50/50 flex items-center justify-center">
      ...
      <div
        ...
        bg-[length:6rem_4rem] 
        bg-[linear-gradient(to_right,_#e5e5e5_1px,transparent_1px),
        linear-gradient(to_bottom,_#e5e5e5_1px,transparent_1px)]"
      />
      <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-10">
        {/* Hero content */}
        <header className="space-y-6 text-center">
          <h1 className="text-5xl font-bold tracking-tight sm:text-7xl bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 bg-clip-text text-transparent">
            It&apos;s Your Sakhi
          </h1>
